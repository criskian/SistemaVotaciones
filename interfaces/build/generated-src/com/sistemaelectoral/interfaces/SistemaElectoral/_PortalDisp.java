...
public abstract class _PortalDisp extends Ice.ObjectImpl implements Portal
{
    ...
    public final String login(String usuario, String password)
    {
        return login(usuario, password, null);
    }

    public final void logout(String usuario)
    {
        logout(usuario, null);
    }

    public static boolean _iceD_login(Portal obj, IceInternal.Incoming inS, Ice.Current current)
        throws Ice.UserException
    {
        ...
        inS.endReadParams();
        String ret = obj.login(iceP_usuario, iceP_password, current);
    ...
    public static boolean _iceD_logout(Portal obj, IceInternal.Incoming inS, Ice.Current current)
        throws Ice.UserException
    {
        _iceCheckMode(Ice.OperationMode.Normal, current.mode);
        Ice.InputStream istr = inS.startReadParams();
        ...
        iceP_usuario = istr.readString();
        inS.endReadParams();
        obj.logout(iceP_usuario, current);
