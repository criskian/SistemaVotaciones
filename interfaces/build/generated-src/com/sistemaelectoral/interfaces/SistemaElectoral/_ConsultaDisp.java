...
public abstract class _ConsultaDisp extends Ice.ObjectImpl implements Consulta
{
    ...
    public static boolean _iceD_obtenerResultados(Consulta obj, IceInternal.Incoming inS, Ice.Current current)
    ...
    public static boolean _iceD_listarCandidatos(Consulta obj, IceInternal.Incoming inS, Ice.Current current)
        throws Ice.UserException
    {
        _iceCheckMode(Ice.OperationMode.Normal, current.mode);
        inS.readEmptyParams();
