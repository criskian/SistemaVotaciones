                             ...
                             java.io.Serializable
{
    ...
    public Voto(String idVotante, int idCandidato)
    {
    ...
    public boolean equals(java.lang.Object rhs)
    {
        ...
        if(r != null)
        {
            if(this.idVotante != r.idVotante)
            {
                if(this.idVotante == null || r.idVotante == null || !this.idVotante.equals(r.idVotante))
                {
                    return false;
                }
            }
    ...
    public int hashCode()
    {
        ...
        h_ = com.zeroc.IceInternal.HashUtil.hashAdd(h_, idVotante);
    ...
    {
        ostr.writeString(this.idVotante);
        ostr.writeInt(this.idCandidato);
    }

    public void ice_readMembers(com.zeroc.Ice.InputStream istr)
    {
        this.idVotante = istr.readString();
