...
public interface HelloPrx extends com.zeroc.Ice.ObjectPrx
{
    default int test()
    {
        return test(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int test(java.util.Map<String, String> context)
    {
        return _iceI_testAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> testAsync()
    {
        return _iceI_testAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> testAsync(java.util.Map<String, String> context)
    {
        return _iceI_testAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> _iceI_testAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "test", null, sync, null);
